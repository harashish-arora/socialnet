...
- Generating the main function for input parsing for `SUGGEST_FRIENDS`, `OUTPUT_POSTS`, and `ADD_POST` commands, which is irrelvant to the logic required for this assignment.
- Generation of ASCII art in the main function, generation of output messages, and exception catching.
- Stylictic refinement.
- Refinment of the "suggestFriends" function for debugging and generation of the custom comparator so used for sorting.
- Refinement of the README file - core compilation instructions were written by myself, and fluff and testcases was generated by LLMs.
- Copying of the core AVL Tree logic from moodle, and refinement of the printRecent function.
- Generation of the extensive 'testcases.txt'.
- The use of AI to maintain structural styling and professional-looking syntax.

The core logic has been written by myself, consisting of the AVL Tree 'printRecent' function and the code under 'social_net.hpp'.
